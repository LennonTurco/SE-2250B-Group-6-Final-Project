...
public class IceCharacterPortrait : MonoBehaviour
{
    [Header("Portraits - 0:Boy 1:ArmsDealer 2:Ninja")]
    [SerializeField] Sprite[] portraits = new Sprite[3];

    [Header("Name display")]
    [SerializeField] TMP_Text nameText;

    Image img;
    string[] names = { "Boy", "Arms Dealer", "Ninja" };
