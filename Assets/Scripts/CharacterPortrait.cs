...
public class CharacterPortrait : MonoBehaviour
{
    ...
    [SerializeField] Sprite[] portraits = new Sprite[5];

    [Header("Name display")]
    [SerializeField] TMP_Text nameText;

    Image img;
    string[] names = { "Boy", "Arms Dealer", "Ninja", "Ice Mage", "Lava Queen" };
    ...
    void Update()
    {
        ...
        else if (Keyboard.current.digit5Key.wasPressedThisFrame) Swap(4);
    }
